...
namespace AuthenticationService.Infrastructure.Gateways
{
    public class SignInGateway : SignInManager<User>
    {
        ...
        public SignInGateway(UserManager<User> userManager,
            ...
            ) : base(userManager, contextAccessor, claimsFactory, optionsAccessor, loggerFactory.CreateLogger<SignInManager<User>>(), schemes, userConfirmation)
        {
        ...
        //    if (result == null)
        //    {
        //        report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.LogOut, ip, headers: headers);
        //    }
        //    else
        //    {
        ...
        //        {
        //            case "Failed":
        //                report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.FailedLogin, ip, "Failed due to invalid login", headers);
        //                break;

        //            case "Lockedout":
        //                report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.FailedLogin, ip, "User account lockedout", headers);
        //                break;

        //            case "NotAllowed":
        //                report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.FailedLogin, ip, "Login method either not allowed or account disabled", headers);
        //                break;

        //            case "RequiresTwoFactor":
        //                report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.FailedLogin, ip, "Account login requires two factor authentication", headers);
        //                break;

        //            case "Succeeded":
        //                report = UserAudit.CreateAuditEvent(user.Id, UserAuditEventType.Login, ip, headers: headers);
        //                break;
        //        }
        //    }
